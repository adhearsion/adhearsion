# [develop](https://github.com/adhearsion/adhearsion)
  * Bugfix: Use `ControlPlayback` rather than redirecting to terminate output in newer versions of Asterisk ([#593](https://github.com/adhearsion/adhearsion/issues/593))
