# develop (2.0.0.head)
  ...
  * Change: The command to take control of a call is now 'take' rather than 'use'.  'take' called without a call ID will result in the first call being taken by the console.
