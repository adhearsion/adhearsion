...
module Adhearsion
  module Asterisk
    ...
    module Commands
      ...
      # @return [Adhearsion::Asterisk::Commands::QueueProxy] a queue proxy object
      #
      # @see http://www.voip-info.org/wiki-Asterisk+cmd+Queue Full information on the Asterisk Queue
      # @see Adhearsion::Asterisk::Commands::QueueProxy#join! join!() for further details
      ...
      def interruptible_play!(*files)
        ...
        files.flatten.each do |file|
          ...
          if result[:endpos].to_i <= startpos
            raise Adhearsion::PlaybackError, "The sound file could not opened to stream.  The parsed response was #{result.inspect}"
          end
      ...
      protected
        ...
        def jump_to_context_with_name(context_name)
          ...
          raise Adhearsion::DSL::Dialplan::ControlPassingException.new(context_lambda)
        end
        ...
        def redefine_extension_to_be(new_extension)
          new_extension = Adhearsion::DSL::PhoneNumber.new new_extension
