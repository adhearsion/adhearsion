...
Adhearsion::Events.framework_theatre.register_namespace_name :asterisk

[:before_call, :after_call, :hungup_call, :failed_call].each do |callback_name|
  Adhearsion::Events.framework_theatre.register_namespace_name [:asterisk, callback_name]
end