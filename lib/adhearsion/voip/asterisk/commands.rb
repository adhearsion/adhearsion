        ...
        module SpeechEngines
          ...
          class << self
            ...
            def unimrcp(call, text, options = {})
              ...
              # asterisk 1.8 messages:     -- AGI Script Executing Application: (MRCPSynth) Options: (<speak xmlns=\"http://www.w3.org/2001/10/synthesis\" version=\"1.0\" xml:lang=\"en-US\"> <voice name=\"Paul\"> <prosody rate=\"1.0\">Howdy\, stranger. How are you today?</prosody> </voice> </speak>)
