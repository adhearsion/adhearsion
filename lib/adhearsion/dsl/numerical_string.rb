module Adhearsion
  module DSL
    ...
    class PhoneNumber < NumericalString
      ...
      def us_local_number?() to_s =~ Adhearsion::Constants::US_LOCAL_NUMBER end

      # Checks against a pattern identifying US domestic numbers.
      def us_national_number?() to_s =~ Adhearsion::Constants::US_NATIONAL_NUMBER end

      # Checks against a pattern identifying an ISN number. See http://freenum.org
      # for more info.
      def isn?() to_s =~ Adhearsion::Constants::ISN end
