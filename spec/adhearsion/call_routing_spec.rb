...
module CallRoutingTestHelper
  private
    def route(*args, &block)
      Adhearsion::CallRouting::Rule.new(*args, &block)
    end
    ...
    def define_rules(&block)
      Adhearsion::CallRouting::Router.define(&block)
    end

    def calculate_route_for(end_point)
      Adhearsion::CallRouting::Router.calculate_route_for(end_point)
    end

    def rules
      Adhearsion::CallRouting::Router.rules
    end
end
