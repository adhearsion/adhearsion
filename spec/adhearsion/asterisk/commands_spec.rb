require 'spec_helper'
require 'adhearsion/menu_state_machine/menu_class'
require 'adhearsion/menu_state_machine/menu_builder'
...
module DialplanCommandTestHelpers
  def self.included(test_case)
    ...
    test_case.before do
      ...
      mock_call.extend(Adhearsion::Asterisk::Commands)
  ...
  private
    ...
    def should_pass_control_to_a_context_that_throws(symbol, &block)
      ...
      begin
        yield
      rescue Adhearsion::DSL::Dialplan::ControlPassingException => cpe
    ...
    def mock_route_calculation_with(*definitions)
      flexmock(Adhearsion::DSL::DialingDSL).should_receive(:calculate_routes_for).and_return(definitions)
    end
...
describe 'The #interruptible_play! method' do
  ...
  it 'should raise an error when the sound file is not found' do
    ...
    }.should raise_error Adhearsion::PlaybackError
    pbx_was_asked_to_stream file
  end
...
describe 'The #inline_return_value method' do
  ...
  it 'should raise AGIProtocolError with an invalid response' do
    ...
    }.to raise_error Adhearsion::Asterisk::AGIProtocolError
...
describe 'The #play_or_speak method' do
  ...
  it 'should raise and error if a sound file does not exist and there is not text specified to fall back to' do
    audio_file = "nixon tapes"
    mock_call.should_receive(:play!).with(audio_file).and_raise Adhearsion::PlaybackError
    the_following_code {
  ...
  it 'should speak the text if a sound file does not exist and pass back the entered text if a key is pressed' do
    audio_file = "nixon tapes"
    mock_call.should_receive(:interruptible_play!).with(audio_file).and_raise Adhearsion::PlaybackError
...
describe 'The #record_to_file! method' do
  ...
  it 'should throw RecordError if the recording had a problem writing the file' do
    ...
    the_following_code {
      mock_call.record_to_file!('foo').should == :write_error
    }.should raise_error Adhearsion::RecordError
  end  
...
describe "The queue management abstractions" do
  ...
  it "queue() should return an instance of QueueProxy" do
    mock_call.queue("foobar").should be_a_kind_of Adhearsion::Asterisk::Commands::QueueProxy
  end
  ...
  it 'a QueueProxy should return a QueueAgentsListProxy when members() is called' do
    mock_call.queue('foobar').agents.should be_a_kind_of(Adhearsion::Asterisk::Commands::QueueProxy::QueueAgentsListProxy)
  end
  ...
  it 'when fetching agents, each array index should be an instance of AgentProxy' do
    ...
    agents.each do |agent|
      agent.should be_a_kind_of Adhearsion::Asterisk::Commands::QueueProxy::AgentProxy
    end
  end
  ...
  it 'should properly retrieve metadata for an AgentProxy instance' do
    ...
    agent = Adhearsion::Asterisk::Commands::QueueProxy::AgentProxy.new("Agent/#{agent_id}", mock_queue)
  ...
  it 'AgentProxy#logged_in? should return true if the "state" of an agent == LOGGEDIN' do
    ...
    agent = Adhearsion::Asterisk::Commands::QueueProxy::AgentProxy.new('Agent/123', mock_queue)
  ...
  it 'the AgentProxy should populate its own "id" property to the numerical ID of the "interface" with which it was constructed' do
    ...
    agent = Adhearsion::Asterisk::Commands::QueueProxy::AgentProxy.new("Agent/#{id}", mock_queue)
    agent.id.should == id

    agent = Adhearsion::Asterisk::Commands::QueueProxy::AgentProxy.new(id, mock_queue)
    agent.id.should == id
  end
  ...
  it 'when a queue agent is dynamically added and the queue does not exist, a QueueDoesNotExistError should be raised' do
    ...
    }.should raise_error Adhearsion::Asterisk::Commands::QueueProxy::QueueDoesNotExistError
  ...
  it 'when a queue agent is dynamiaclly added and the adding was successful, an AgentProxy should be returned' do
    ...
    return_value.kind_of?(Adhearsion::Asterisk::Commands::QueueProxy::AgentProxy).should be true
  end
...
describe 'the menu() method' do
  ...
  it "should instantiate a new Menu object with only the Hash given as menu() options" do
    ...
    flexmock(Adhearsion::Menu).should_receive(:new).once.
...
describe 'the Menu class' do
  ...
  it "should yield a MenuBuilder when instantiated" do
    lambda {
      Adhearsion::Menu.new do |block_argument|
        block_argument.should be_a_kind_of Adhearsion::MenuBuilder
        throw :inside_block
      end
...
describe 'the MenuBuilder' do
  ...
  attr_reader :builder
  before(:each) do
    @builder = Adhearsion::MenuBuilder.new
  end
  ...
  it "should convert each pattern given to it into a MatchCalculator instance" do
    ...
    builder.weighted_match_calculators.each do |match_calculator|
      match_calculator.should be_a_kind_of Adhearsion::MatchCalculator
    end
  end
...
describe 'the enable_feature command' do
  ...
  it 'should check Adhearsion::Asterisk::Commands::DYNAMIC_FEATURE_EXTENSIONS mapping for configuration setters' do
    ...
    old_hash_feature_extension = Adhearsion::Asterisk::Commands::DYNAMIC_FEATURE_EXTENSIONS[feature_name]
    begin
      Adhearsion::Asterisk::Commands::DYNAMIC_FEATURE_EXTENSIONS[feature_name] = assertion
      # </uglyhack>
      should_throw :inside_assertion! do
        mock_call.enable_feature(feature_name, :this_is_the_right_arg)
      end
    ensure
      Adhearsion::Asterisk::Commands::DYNAMIC_FEATURE_EXTENSIONS[feature_name] = old_hash_feature_extension
    end
  end
...
describe 'jump_to command' do
  ...
  it "a clearly invalid context name should raise a ContextNotFoundException" do
    ...
    }.should raise_error Adhearsion::DSL::Dialplan::ContextNotFoundException
  end
  ...
  it 'when given an :extension override, the new value should be boxed in a PhoneNumber' do
    ...
    rescue Adhearsion::DSL::Dialplan::ControlPassingException
...
describe "speak command" do
  ...
  before :all do
    @speech_engines = Adhearsion::Asterisk::Commands::SpeechEngines
  end
