...
require 'adhearsion/menu_state_machine/matchers'
...
describe "MatchCalculator" do
  it "the build_with_pattern() method should return an appropriate subclass instance based on the pattern's class" do
    Adhearsion::MatchCalculator.build_with_pattern(1..2, :main).should be_an_instance_of Adhearsion::RangeMatchCalculator
  end
...
describe "The RangeMatchCalculator" do
  ...
  it "matching with a Range should handle the case of two potential matches in the range" do
    ...
    calculator = Adhearsion::RangeMatchCalculator.new 11..1111, :match_payload_doesnt_matter
  ...
  it 'return values of #match should be an instance of CalculatedMatch' do
    calculator = Adhearsion::RangeMatchCalculator.new 1..9, :match_payload_doesnt_matter
    calculator.match(0).should be_an_instance_of Adhearsion::CalculatedMatch
    calculator.match(1000).should be_an_instance_of Adhearsion::CalculatedMatch
  end
...
describe "FixnumMatchCalculator" do
  ...
  it "a potential match scenario" do
    calculator = Adhearsion::FixnumMatchCalculator.new(444, match_payload)
  ...
  it 'a multi-digit exact match scenario' do
    calculator = Adhearsion::FixnumMatchCalculator.new(5555, match_payload)
    calculator.match(5555).exact_match?.should be true
  end

  it 'a single-digit exact match scenario' do
    calculator = Adhearsion::FixnumMatchCalculator.new(1, match_payload)
  ...
  it 'the context name given to the calculator should be passed on to the CalculatedMatch' do
    ...
    calculator = Adhearsion::FixnumMatchCalculator.new(1337, match_payload)
...
describe "StringMatchCalculator" do
  ...
  it "numerical digits mixed with special digits" do
    ...
    %w[5*11#3 5*** ###].each do |str|
      calculator = Adhearsion::StringMatchCalculator.new(str, match_payload)
  ...
  it "matching the special DTMF characters such as * and #" do
    %w[* #].each do |special_digit|
      calculator = Adhearsion::StringMatchCalculator.new(special_digit, match_payload)
